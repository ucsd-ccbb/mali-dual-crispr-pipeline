...
for (iter in 1:niter) {
  gIrlsLogStrings = append(gIrlsLogStrings, capture.output(cat("\n",iter,"\n")))
  ...
  gIrlsLogStrings = append(gIrlsLogStrings, res2[[4]])
...
writePosteriorProbabilityFile(pi_mean, pi_sd, pi_iter_null, g1names, g2names, ggnames, uutri, f, gFdrsList$fdr_left, gFdrsList$fdr_right)
