...
from ccbb_pyutils.files_and_paths import build_multipart_fp, get_file_name_pieces, \
...
def plot_combined_raw_counts(input_dir, input_run_prefix, combined_suffix, output_dir, output_run_prefix,
                             boxplot_suffix):
