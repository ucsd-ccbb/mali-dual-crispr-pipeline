...
def get_ints_from_comma_sep_string(comma_sep_string):
    return _split_delimited_string_to_list(comma_sep_string, int, ",")


def _split_delimited_string_to_list(input_str, cast_func, delimiter_str):
