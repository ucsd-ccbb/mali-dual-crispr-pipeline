...
def parse_cmd_line_args():
    ...
    return args.dataset_name, args.library_name, args.counts_fp_or_dir, args.day_timepoints_str, args.test


def main():
    human_readable_name, library_name, counts_fp_or_dir, day_timepoints_str, is_test = parse_cmd_line_args()
