...
class TestFittedPerReplicateData(unittest.TestCase):
    ...
    def help_make_fitted_rep(get_rep_1=True):
        ...
        unnormed_fitness_per_construct_series = ns_help.TestScorer.help_make_naive_fcs_series()
    ...
    def help_make_lambda_by_timepoints_series(get_rep_1=True):
        if get_rep_1:
            file_name = "lambda1.txt"
        else:
            file_name = "lambda2.txt"
...
class TestFunctions(unittest.TestCase):
    ...
    def test__calculate_unnormed_fitness_mult_by_time_per_construct_per_timept_df(self):
        # only tested for replicate 1
        input_naive_fcs_series = ns_help.TestScorer.help_make_naive_fcs_series()
        ...
        real_output_df = ns_test._calculate_unnormed_fitness_mult_by_time_per_construct_per_timept_df(
    ...
    def test__calculate_normed_init_log2_fraction_plus_unnormed_fitness_mult_by_time_per_construct_per_timept_df(self):
        # only tested for replicate 1
        ...
        real_output_df = \
            ns_test._calculate_normed_init_log2_fraction_plus_unnormed_fitness_mult_by_time_per_construct_per_timept_df(
